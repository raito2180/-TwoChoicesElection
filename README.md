...
**DB:postgresql**<br>
gem postgresqlを使用予定<br>
**PaaS:Vercel&Render**<br>
フロントエンドはVercelにてマージ後に自動デプロイ機能もありGithubActionsを活用しなくてもよいなどデプロイ時の使用感がとても<br>
良かった為使用予定です。バックエンドはRender.comを使用予定です。GitHubにpushすると自動で行われる点を再評価しました<br>
